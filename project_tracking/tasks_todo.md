...
- `REALTIME-MEMBERSHIP-REPAIR-01` completed. Player campaign self-join now refreshes session/member state immediately, and the DM Screen exposes UUID-based campaign player add before session add/remove.
