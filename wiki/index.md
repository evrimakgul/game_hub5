...
| [ui-and-routes-map](./runtime/ui-and-routes-map.md) | Current route map and the main player/DM interaction surfaces. | 2026-05-12 |
...
| [realtime-sessions](./domains/realtime-sessions.md) | Optional Supabase-backed live DM/player sessions, secret rolls, sharing, rewards, events, and RLS-backed tables. | 2026-05-12 |
